...
from younger.applications.models.link_prediction import GCN_LP, GAT_LP, SAGE_LP
from younger.applications.models.node_prediction import GCN_NP, GAT_NP, SAGE_NP