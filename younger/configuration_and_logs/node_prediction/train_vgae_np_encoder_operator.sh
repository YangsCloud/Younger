...
THIS_NAME=vgae_np_encoder_operator

CONFIG_FILEPATH=${THIS_NAME}.toml
CHECKPOINT_DIRPATH=./checkpoint-vgae-np/${THIS_NAME}
...
CUDA_LAUNCH_BLOCKING=1 CUBLAS_WORKSPACE_CONFIG=:4096:8 younger applications deep_learning train \
  ...
  --life-cycle 100 --report-period 100 --update-period 1 --train-period 200 --valid-period 200 \
  --device GPU \
