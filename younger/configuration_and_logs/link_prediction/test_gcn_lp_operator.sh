...
THIS_NAME=gcn_lp_operator

CONFIG_FILEPATH=${THIS_NAME}.toml
CHECKPOINT_DIRPATH=./checkpoint-gcn-lp/${THIS_NAME}
CHECKPOINT_NAME=${THIS_NAME}
CHECKPOINT_FILEPATH=/root/autodl-tmp/Experiments/Link_prediction/checkpoint-gcn-lp/gcn_lp_operator/gcn_lp_operator_Epoch_1_Step_1000.cp
