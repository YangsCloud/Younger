...
class Network(object):
    def __init__(
        ...
        opset_import: List[Dict[str, Union[str, int]]] = graph.graph.get('opset_import', None)
        producer_name: Optional[str] = graph.graph.get('producer_name', None)
        producer_version: Optional[str] = graph.graph.get('producer_version', None)
        domain: Optional[str] = graph.graph.get('domain', None)
        model_version: Optional[int] = graph.graph.get('model_version', None)
        doc_string: Optional[str] = graph.graph.get('doc_string', None)
        metadata_props: Optional[List[Dict[str, str]]] = graph.graph.get('metadata_props', None)
