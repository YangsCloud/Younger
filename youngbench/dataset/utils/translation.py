...
def trans_model_proto(model: onnx.ModelProto, verbose: bool = False) -> networkx.DiGraph:
    ...
    opset_import: List[Dict[str, Union[str, int]]] = list()
    for ox_model_opset_import in model.opset_import:
        ox_model_opset_import: Dict[str, Union[str, int]] = trans_operator_set_id_proto(ox_model_opset_import)
